...
from cdsw_actions import DuckSearch, WikipediaSearch
...
class CDSWProjectAgent(BaseAgent):
    ...
    def __build_examples__(self):
        ...
        thought = "Based on the context I have, the relevant endpoint that will help me create a project is '/api/v2/projects' with the POST HTTP method. This call requires a JSON payload with project details like name, description etc."
